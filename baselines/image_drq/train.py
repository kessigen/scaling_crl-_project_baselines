...
def main():
    ...
    parser.add_argument("--run-dir", default="runs/wx250_image_drq")
    ...
    parser.add_argument("--legacy-reward", action="store_true", help="Use the pre-rebalance staged reward (0.3/0.7/-0.02, success=100). For resuming old checkpoints.")
