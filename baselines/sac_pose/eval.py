"""eval / GIF recorder for the pose-SAC in-zone-success checkpoints.

loads an SB3 SAC .zip and rolls it out for N episodes on the in-zone env,
reporting in-zone-at-end SR, return, episode length and mean in_zone_fraction.

note: render mode is rgb_array . still renders for visualization
"""
...
def make_env(
    ...
    return WX250PickPlaceImageInZoneEnv(
...
def main():
    ...
    parser.add_argument("--model", required=True, help="Path to SB3 SAC .zip checkpoint")
